...
<div class="container mx-auto lg:mt-2 lg:mb-2">
    ...
    <form action="{{ route('categorias.store') }}" method="post" class="mx-auto w-1/2 rounded m-5 p-5 bg-gray-700 text-gray-400">
        @csrf
        <div class="mb-6">
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear categoria</button>
    </form>
